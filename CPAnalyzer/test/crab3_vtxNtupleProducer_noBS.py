...
#config.General.requestName = 'GGF120_8TeV_v25_noBS'
config.General.requestName = 'GGF125_8TeV_v25_noBS'
...
config.JobType.psetName = 'diTauPairVertexStudy_noBS_cfg.py'
