...
void plotMacroPhi(TString histname_, float xmin_, float xmax_, float ymin_, float ymax_, TString xtitle_, TString ytitle_, TString outFileName_)
{
  ...
  TFile *f2 = TFile::Open("SUSYGluGluToHToTauTau_M-All_MC_v18.root", "READONLY");
  ...
  TFile *f3 = TFile::Open("DYJetsToLL_M-50_MC_v18.root", "READONLY");
...
void plotMacroPhiAll()
{
  ...
  //plotMacroPhi("CPPhiStar_M2_gentau", 0., 3.2, 0., 0.15, "#phi^{*} (Radian)", "Arbitrary Units", "cp_phi_star_m2_gentau");
  //plotMacroPhi("CPPhiStar_LE1_gentau", 0., 3.2, 0., 0.15, "#phi^{*} (Radian)", "Arbitrary Units", "cp_phi_star_gentau");
  //plotMacroPhi("CPPhiStar_tau30", 0., 3.2, 0., 0.15, "#phi^{*} (Radian)", "Arbitrary Units", "cp_phi_star_tau30");
  ...
  //plotMacroPhi("CPPhiStar_genvtx_gentau", 0., 3.2, 0., 0.15, "#phi^{*} (Radian)", "Arbitrary Units", "cp_phi_star_genvtx_gentau");
  //plotMacroPhi("CPPhiStar_genvtx_tau30", 0., 3.2, 0., 0.15, "#phi^{*} (Radian)", "Arbitrary Units", "cp_phi_star_genvtx_tau30");
  ...
  //plotMacroPhi("CPPhiStar_gen", 0., 3.2, 0., 0.15, "#phi^{*} (Radian)", "Arbitrary Units", "cp_phi_star_gen");
  //plotMacroPhi("CPPhiStar_gen_CP", 0., 6.4, 0., 0.1, "#phi^{*}_{CP} (Radian)", "Arbitrary Units", "cp_phi_star_gen_cp");
