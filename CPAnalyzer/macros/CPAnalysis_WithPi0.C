...
std::map<std::string, TH1F*>  createHistograms(){
  ...
  histos_["CPPhiStar_gen_ycutP"] = new TH1F("CPPhiStar_gen_ycutP",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_ycutN"] = new TH1F("CPPhiStar_gen_ycutN",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_vs_ycutP"] = new TH1F("CPPhiStar_gen_vs_ycutP",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_vs_ycutN"] = new TH1F("CPPhiStar_gen_vs_ycutN",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_vipsv2_ycutP"] = new TH1F("CPPhiStar_gen_vipsv2_ycutP",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_vipsv2_ycutN"] = new TH1F("CPPhiStar_gen_vipsv2_ycutN",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_pcas_ycutP"] = new TH1F("CPPhiStar_gen_pcas_ycutP",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_pcas_ycutN"] = new TH1F("CPPhiStar_gen_pcas_ycutN",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_ycutP_visPt50"] = new TH1F("CPPhiStar_gen_ycutP_visPt50",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_ycutN_visPt50"] = new TH1F("CPPhiStar_gen_ycutN_visPt50",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_vipsv2_ycutP_visPt50"] = new TH1F("CPPhiStar_gen_vipsv2_ycutP_visPt50",  "", 18, 0.0, 3.14159);
  histos_["CPPhiStar_gen_vipsv2_ycutN_visPt50"] = new TH1F("CPPhiStar_gen_vipsv2_ycutN_visPt50",  "", 18, 0.0, 3.14159);
...
void VertexAnalysis(TString inputFilePath_, TString outFileName_, int HPid_)
{
  ...
  for (int n = 0; n < nEntries; n++) {
	...
	if(genVPid_ == HPid_){
	  ...
	  LV genpi0sP_lab(0, 0, 0, 0); LV genpi0sN_lab(0, 0, 0, 0);
	  Point3D genpionPVtx_(0, 0, 0); Point3D genpionNVtx_(0, 0, 0);
	  int npionP = 0, npionN = 0, nphP = 0, nphN = 0; 
	  //if(genTauPSonsP4_->size()>0 && genTauPSonsP4_->size()<3 && genTauPSonsPid_->size() > 0){ //take only one prong
	  if(genTauPSonsP4_->size()>0 && genTauPSonsPid_->size() > 0){//take only one prong with pi0
	    for(size_t i = 0; i<genTauPSonsP4_->size(); i++){
	      //cout<<"tau P sons pid "<<(*genTauPSonsPid_)[i]<<" status "<<(*genTauPSonsStatus_)[i]<<endl;
	      if(abs((*genTauPSonsPid_)[i]) == 211){
		genpionP_lab = (*genTauPSonsP4_)[i];
		genpionPVtx_ = (*TauPSonsGenVtx_)[i];
		npionP++;
	      }
	      if(abs((*genTauPSonsPid_)[i]) == 22 && (*genTauPSonsStatus_)[i] == 1 ){
		nphP++;
		genpi0sP_lab += (*genTauPSonsP4_)[i];
	      }
	    }
	  }
	  //if(genTauNSonsP4_->size()>0 && genTauNSonsP4_->size()<3 && genTauNSonsPid_->size() > 0){ //take only one prong
	  if(genTauNSonsP4_->size()>0 && genTauNSonsPid_->size() > 0){//take only one prong with pi0
            for(size_t i = 0; i<genTauNSonsP4_->size(); i++){
	      //cout<<"tau N sons pid "<<(*genTauNSonsPid_)[i]<<" status "<<(*genTauNSonsStatus_)[i]<<endl;
              if(abs((*genTauNSonsPid_)[i]) == 211){
		genpionN_lab = (*genTauNSonsP4_)[i];
		genpionNVtx_ = (*TauNSonsGenVtx_)[i];
		npionN++;
	      }
	      if(abs((*genTauNSonsPid_)[i]) == 22 && (*genTauNSonsStatus_)[i] == 1){
		nphN++;
		genpi0sN_lab += (*genTauNSonsP4_)[i];
	      }
            }
          }
	  ...
	  //Point3D GenHVtx_ =  (*HiggsGenVtx_)[0];
	  //if(npionP == 1 && npionN == 1 && nphP>0 && nphN>0)cout<<"found event with 1prong+npi0s"  <<endl;
	  if(genpionP_lab.pt() > 0 && genpionN_lab.pt() > 0 && npionP == 1 && npionN == 1 && nphP == 2 && nphN == 2){//1prong + 1pi0s
	    ...
	    //Apply cut on Y2.Y1 defined by S. Berge
	    double Yp = (genpionP_lab.e() - genpi0sP_lab.e())/(genpionP_lab.e() + genpi0sP_lab.e());
	    double Yn = (genpionN_lab.e() - genpi0sN_lab.e())/(genpionN_lab.e() + genpi0sN_lab.e());
	    if(Yp*Yn >= 0){histos_["CPPhiStar_gen_ycutP"]->Fill(phi_star_gen);
	      if((genpionP_lab+genpi0sP_lab).pt() > 50 && (genpionN_lab+genpi0sN_lab).pt() > 50)histos_["CPPhiStar_gen_ycutP_visPt50"]->Fill(phi_star_gen);
	    }
	    else if(Yp*Yn < 0 ){histos_["CPPhiStar_gen_ycutN"]->Fill(phi_star_gen);
	      if((genpionP_lab+genpi0sP_lab).pt() > 50 && (genpionN_lab+genpi0sN_lab).pt() > 50)histos_["CPPhiStar_gen_ycutN_visPt50"]->Fill(phi_star_gen);
	    }
	    ...
	    if(Yp*Yn >= 0)histos_["CPPhiStar_gen_vs_ycutP"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_s.Dot(ipvN_rf_gen_3d_t_u_s)));
	    else if(Yp*Yn < 0 )histos_["CPPhiStar_gen_vs_ycutN"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_s.Dot(ipvN_rf_gen_3d_t_u_s)));
	    ...
	    if(Yp*Yn >= 0){histos_["CPPhiStar_gen_vipsv2_ycutP"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_vipsv2.Dot(ipvN_rf_gen_3d_t_u_vipsv2)));
	      if((genpionP_lab+genpi0sP_lab).pt() > 50 && (genpionN_lab+genpi0sN_lab).pt() > 50)histos_["CPPhiStar_gen_vipsv2_ycutP_visPt50"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_vipsv2.Dot(ipvN_rf_gen_3d_t_u_vipsv2)));
	    }
	    else if(Yp*Yn < 0 ){histos_["CPPhiStar_gen_vipsv2_ycutN"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_vipsv2.Dot(ipvN_rf_gen_3d_t_u_vipsv2)));
	      if((genpionP_lab+genpi0sP_lab).pt() > 50 && (genpionN_lab+genpi0sN_lab).pt() > 50)histos_["CPPhiStar_gen_vipsv2_ycutN_visPt50"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_vipsv2.Dot(ipvN_rf_gen_3d_t_u_vipsv2)));
	    }
	    ...
	    if(Yp*Yn >= 0)histos_["CPPhiStar_gen_pcas_ycutP"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_ips.Dot(ipvN_rf_gen_3d_t_u_ips)));
	    else if(Yp*Yn < 0 )histos_["CPPhiStar_gen_pcas_ycutN"]->Fill(TMath::ACos(ipvP_rf_gen_3d_t_u_ips.Dot(ipvN_rf_gen_3d_t_u_ips)));
    ...
    if(decayModeLeg1_ <= 1 && decayModeLeg2_ <= 1) passDecayMode = true; //1 prong+pi0s
    ...
    if(genDecayModeLeg1_ <= 2 && trackPtLeg1_ > 20 && trackPtErrLeg1_/trackPtLeg1_ < 0.10 &&
       nHitsLeg1_ >= 8 && nPxlHitsLeg1_ >= 2 && nMisingHitsLeg1_ == 0 && TMath::Abs(etaL1) < 1.5)
      passQualityLeg1_ = true;
    if(genDecayModeLeg2_ <= 2 && trackPtLeg2_ >20 && trackPtErrLeg2_/trackPtLeg2_ < 0.10 &&
    ...
    if(genDecayModeLeg1_ <= 2 && genDecayModeLeg2_ <= 2)
...
void VertexAnalysisAll()
{
  ...
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/DYJetsToLL_M-50_MC_v20/", "CPWthPi0s/DYJetsToLL_M-50_MC_v21", 23);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-110_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-110_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-115_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-115_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-120_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-120_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-125_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-125_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-130_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-130_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-135_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-135_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-140_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-140_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-145_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-145_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-150_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-150_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-155_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-155_MC_v21", 25);
  //VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/GluGluToHToTauTau_M-160_MC_v21/", "CPWthPi0s/GluGluToHToTauTau_M-160_MC_v21", 25);
  VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/SUSYGluGluToHToTauTau_M-100_MC_v21/", "CPWthPi0s/SUSYGluGluToHToTauTau_M-100_MC_v21", 36);
  VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/SUSYGluGluToHToTauTau_M-110_MC_v21/", "CPWthPi0s/SUSYGluGluToHToTauTau_M-110_MC_v21", 36);
  VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/SUSYGluGluToHToTauTau_M-120_MC_v21/", "CPWthPi0s/SUSYGluGluToHToTauTau_M-120_MC_v21", 36);
  VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/SUSYGluGluToHToTauTau_M-130_MC_v21/", "CPWthPi0s/SUSYGluGluToHToTauTau_M-130_MC_v21", 36);
  VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/SUSYGluGluToHToTauTau_M-140_MC_v21/", "CPWthPi0s/SUSYGluGluToHToTauTau_M-140_MC_v21", 36);
  VertexAnalysis("/nfs/dust/cms/user/anayak/CMS/Ntuple_VertexStudy/SUSYGluGluToHToTauTau_M-160_MC_v21/", "CPWthPi0s/SUSYGluGluToHToTauTau_M-160_MC_v21", 36);
